...
<div class="inventario form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
	    $checked = ($inventario->sobrecor) ? '' : 'checked';
	    ...
	    echo "<input type='checkbox' name='desliga' id='desliga' onclick='ligacor()' ".$checked.">". __('Usar cor padrao');
            echo $this->Farbtastic->input('inventario.sobrecor',$inventario->sobrecor);
        ?>
    </fieldset>
