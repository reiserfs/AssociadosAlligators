<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Associado'), ['action' => 'edit', $associado->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Associado'), ['action' => 'delete', $associado->id], ['confirm' => __('Are you sure you want to delete # {0}?', $associado->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Associados'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Associado'), ['action' => 'add']) ?> </li>
    </ul>
</nav>
