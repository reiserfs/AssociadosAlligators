	...
	<tr valign="top">
		...
		<td width="80%">
			<table class="horizontal-table">
				...
				<?= $associado->has('time') ? $this->Html->link($associado->time->nome, ['controller' => 'Time', 'action' => 'view', $associado->time->id]) : '' ?></center>
					</td>
				</tr>
				<tr valign="top">
					<td width="63%" class="view_associados">
        ...
        <table id='fullBody' cellpadding="0" cellspacing="0">
          <tr>
			...
			<?php echo $this->Html->image($this->Url->build([ 
							...
							'url' => ['controller' => 'Perfil', 'action' => 'vequip', $equipado['Capacete']['id']] 
							])?> 
		   </th>
                  </tr>
                  <tr>
			...
			<?php echo $this->Html->image($this->Url->build([ 
							...
							'url' => ['controller' => 'Perfil', 'action' => 'vequip', $equipado['Shoulderpad']['id']] 
						 	])?> 
			</th>
                  </tr>
                  <tr>
			...
			<?php echo $this->Html->image($this->Url->build([ 
							...
							'url' => ['controller' => 'Perfil', 'action' => 'vequip', $equipado['Luva']['id']] 
							])?> 
		    </th>
                  </tr>
                  <tr>
			...
			<?php echo $this->Html->image($this->Url->build([ 
							...
							'url' => ['controller' => 'Perfil', 'action' => 'vequip', $equipado['Camisa']['id']] 
							])?> 
		     </th>
                  </tr>
                  <tr>
			...
			<?php echo $this->Html->image($this->Url->build([ 
							...
							'url' => ['controller' => 'Perfil', 'action' => 'vequip', $equipado['Calca']['id']] 
							])?> 
		     </th>
                  </tr>
                  <tr>
			...
			<?php echo $this->Html->image($this->Url->build([ 
							...
							'url' => ['controller' => 'Perfil', 'action' => 'vequip', $equipado['Meiao']['id']] 
							])?> 
		     </th>
                  </tr>
                  <tr>
			...
			<?php echo $this->Html->image($this->Url->build([ 
							...
							'url' => ['controller' => 'Perfil', 'action' => 'vequip', $equipado['Chuteira']['id']] 
							])?> 
		    </th>
                  </tr>
               </table>
