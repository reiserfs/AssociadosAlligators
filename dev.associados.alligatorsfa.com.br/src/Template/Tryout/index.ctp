    ...
    <table cellpadding="0" cellspacing="0">
		...
		<td><?php echo $sexoicon?><?= h($associado->apelido) ?></td>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link($this->Html->image('aprove.png',['alt' =>__('Aprovar')]), ['action' => 'aprova', $associado->id],['escape'=>false]) ?>
                    <?= $this->Html->link($this->Html->image('update.png',['alt' =>__('Atualizar Cadastro Existente')]), ['action' => 'update', $associado->id],['escape'=>false]) ?>
                    <?= $this->Html->link($this->Html->image('edit.png',['alt' =>__('Edit')]), ['action' => 'edit', $associado->id],['escape'=>false]) ?>
                    <?= $this->Form->postLink($this->Html->image('delete.png',['alt' =>__('Delete')]), ['action' => 'delete', $associado->id], ['escape' => false,'confirm' => __('Are you sure you want to delete # {0}?', $associado->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
